![header](https://capsule-render.vercel.app/api?type=waving&color=A9A9A9&fontAlign=50&fontAlignY=30&text=GyeongDon&desc=Github&descAlign=70&descAlignY=55&height=200&fontSize=60&fontColor=ffffff)
...
- [PORTFOLIO](https://doni3134.github.io/indexResume-1/) click!

- 2024
- 대한간호협회 문제은행 프로젝트 참여
- 한국환경보전원 환경교육사 문제은행 프로젝트 참여
- 세종학당재단 IBT 프로젝트 참여
- 환경측정분석사 문제은행 프로젝트 참여
- 한국교육개발원 KEDI 단원평가 시스템 개발
- 회사 홈페이지 리뉴얼 담당
- 사내 시스템 ClassRoom UI 수정
- 사내 시스템 기능 개선 및 추가
- 한국산업인력공단 문제은행시스템, 동영상전송시스템 시스템유지보수

- 2025
- 세종한국어평가 SKA 시스템 기능개선
- 한국교통안전공단 프로젝트 참여
- 경기도소방학교 문제은행 참여
- 등불쌤해양경찰학원 프로젝트 참여 (문제은행, 응시프로그램)
- 한전 KPS 문제은행 프로젝트 참여
- 생명보험협회 IBT시스템, 문제은행, 자격시험통합관리시스템, 자격시험센터 참여
- G1230 시스템 유지보수

- 2026
- 한국금융연수원 문제은행 기능개선
- 한국금융연수원 집합연수 평가관리시스템 기능개선
- 한국병원약사회 문제은행 기능개선
- 의료기기정보기술지원센터 문제은행 기능개선
- AI 시험지 자동조판프로그램 개발
- 
